    ...
    <div class="main-card" style="margin-top:90px;">
        ...
        <form action="{{ route('items.store') }}" method="POST" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="codigo" name="codigo" class="form-control" required autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="descripcion">Descripción</label>
                <textarea id="descripcion" name="descripcion" class="form-control" rows="3" autocomplete="off"></textarea>
            </div>
            <button type="submit" class="btn btn-pastel-save">Guardar</button>
