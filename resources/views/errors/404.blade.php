...
<h1 class="wave-text">ERROR 404</h1>
<h2 class="wave-underline">Ups! Contacta al Ing para solucionar el error</h2>
...
/* WAVE TEXT (GRADIENT MOVING) */
.wave-text {
  font-size: 4rem;
  font-weight: 800;
  background: linear-gradient(90deg, #39ac31, #6ecb9f, #39ac31);
...
.wave-underline::after {
  ...
  animation: underline-wave 2s linear infinite;
}
