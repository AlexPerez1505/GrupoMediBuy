...
<head>
  ...
  <style>
    ...
    .btn-500 {
      ...
      box-shadow: 0 2px 14px #fb6a4f25;
      border: none;
      cursor: pointer;
    }
    .btn-500:hover {
    ...
    @media (max-width: 700px) {
      #error-500-svg {max-width: 96vw;}
      .msg-500 {font-size:1.05rem;}
    }
  </style>
</head>
<body>
  <svg id="error-500-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-8.5 9.5 560 250">
  ...
  <div class="msg-500">
    ¡Vaya! Algo salió mal en el servidor.<br>
    <a href="{{ url('/login') }}" class="btn-500">Volver al inicio</a>
  </div>
</body>
</html>
