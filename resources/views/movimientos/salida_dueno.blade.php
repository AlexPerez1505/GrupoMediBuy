...
<div class="formulario-contenedor">
    ...
    <p class="card-text">Registro de <strong>salida a dueño</strong> del equipo.</p>

    <form action="{{ route('movimientos.guardar', $id) }}" method="POST" enctype="multipart/form-data">
        @csrf

        <input type="hidden" name="tipo_movimiento" value="salida_dueno">

   <!-- Checklist antes de entrega a dueño --> 
<div class="form-group">
    <label class="titulo-defectos">Checklist de entrega</label>
    <div class="defecto-container">
        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-1" name="checklist[]" value="Equipo limpio">
            <label for="check-entrega-1">Equipo limpio</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-2" name="checklist[]" value="Pruebas funcionales exitosas">
            <label for="check-entrega-2">Pruebas funcionales exitosas</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-3" name="checklist[]" value="Accesorios completos y revisados">
            <label for="check-entrega-3">Accesorios completos y revisados</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-4" name="checklist[]" value="Validación de número de serie">
            <label for="check-entrega-4">Validación de número de serie</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-5" name="checklist[]" value="Confirmación de funcionamiento de botones">
            <label for="check-entrega-5">Confirmación de funcionamiento de botones</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-6" name="checklist[]" value="Inspección visual final">
            <label for="check-entrega-6">Inspección visual final</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-7" name="checklist[]" value="Embalaje correcto">
            <label for="check-entrega-7">Embalaje correcto</label>
        </div>

        <div class="checkbox-card">
            <input type="checkbox" id="check-entrega-8" name="checklist[]" value="Verificación de conectores y cables">
            <label for="check-entrega-8">Verificación de conectores y cables</label>
        </div>
    </div>
</div>
        ...
        <!-- Descripción -->
        <div class="mb-3">
            <label for="descripcion" class="form-label">Observaciones / Notas finales</label>
            <textarea class="form-control" name="descripcion" placeholder="Condición final del equipo, notas adicionales, etc." style="height: 130px;" required></textarea>
        </div>
