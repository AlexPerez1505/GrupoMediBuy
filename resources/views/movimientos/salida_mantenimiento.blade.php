...
<div class="formulario-contenedor">
    ...
    <p class="card-text">Registro de <strong>salida a mantenimiento</strong> del equipo.</p>

    <form action="{{ route('movimientos.guardar', ['id' => $servicio->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<div class="form-group">
    ...
    <div class="defecto-container">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control select" name="descripcion" placeholder="Escribe una descripción del estado del equipo antes de salir." style="height: 130px;" required></textarea>
        </div>
