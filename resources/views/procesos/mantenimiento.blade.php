...
<div class="formulario-contenedor">
    ...
    <p class="card-text">Aquí puedes gestionar el proceso de mantenimiento del equipo con ID {{ $id }}.</p>
    ...
    <form id="formulario-stock" action="{{ route('procesos.guardar', $id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control select" name="descripcion_proceso" placeholder="Describe el mantenimiento realizado." style="height: 130px;" required></textarea>
        </div>
