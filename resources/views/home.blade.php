...
<head>
  ...
  <style>
    ...
    *{ margin:0; padding:0; box-sizing:border-box; font-family:"Poppins",sans-serif; }
    ...
    header img{ height:95px; margin-top:-25px; }
...
<body>
  ...
  <h3 style="text-align: center; width: 100%; margin-bottom: 20px;">Tus accesos</h3>
  <div class="menu-grid" id="menuGrid">
    ...
    @else
      ...
      @if(Auth::user()->hasRole('admin'))
        ...
        <!-- Botón flotante -->
        <a href="/whatsapp/inbox" target="_self" class="registro-btn" title="WhatsApp Help Desk">
