...
<div class="form-container">
    ...
    <form id="cuentaForm" action="{{ route('cuentas.store') }}" method="POST" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="lugar" name="lugar" placeholder="Ej. Oaxaca, México" required>
            <div id="lugarError" class="error-text"></div>
        </div>

        <div class="mb-3">
            <label for="casetas" class="form-label">Casetas</label>
            <input type="number" step="0.01" class="form-control" id="casetas" name="casetas" value="0" required>
            <div id="casetasError" class="error-text"></div>
        </div>

        <div class="mb-3">
            <label for="gasolina" class="form-label">Gasolina</label>
            <input type="number" step="0.01" class="form-control" id="gasolina" name="gasolina" value="0" required>
            <div id="gasolinaError" class="error-text"></div>
        </div>

        <div class="mb-3">
            <label for="viaticos" class="form-label">Viáticos</label>
            <input type="number" step="0.01" class="form-control" id="viaticos" name="viaticos" value="0" required>
            <div id="viaticosError" class="error-text"></div>
        </div>

        <div class="mb-3">
            <label for="adicional" class="form-label">Adicional (opcional)</label>
            <input type="number" step="0.01" class="form-control" id="adicional" name="adicional" value="0">
        ...
        <div class="mb-3" id="descripcionGroup" style="display:none;">
            ...
            <textarea class="form-control" id="descripcion" name="descripcion" rows="2" placeholder="Describe en qué consiste el adicional (opcional)"></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calcularTotal() {
        const suma = parseFloat(casetas.value || 0) + parseFloat(gasolina.value || 0) + parseFloat(viaticos.value || 0) + parseFloat(adicional.value || 0) + 500;
