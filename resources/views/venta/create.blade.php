...
<div class="form-group position-relative mt-4" style="max-width: 900px; width: 100%;">
    ...
    <input type="hidden" name="carta_garantia_id" id="carta_garantia_id">

    <ul id="dropdown_cartas" class="list-group position-absolute w-100 mt-1 shadow-sm" style="z-index: 1000; display: none; max-height: 250px; overflow-y: auto;">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const originalOptions = [...dropdown.querySelectorAll('.list-option-carta')];
