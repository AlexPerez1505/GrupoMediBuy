...
<div class="container mt-4">
    <div class="main-card">
        ...
        <div>
            <p class="detalle-label">Item:</p>
            <div class="detalle-value">{{ $itemParte->item->nombre }}</div>
            <p class="detalle-label">Nombre Parte:</p>
            <div class="detalle-value">{{ $itemParte->nombre_parte }}</div>
            <p class="detalle-label">Código Parte:</p>
            <div class="detalle-value">{{ $itemParte->codigo_parte }}</div>
            <p class="detalle-label">Descripción:</p>
            <div class="detalle-value">{{ $itemParte->descripcion }}</div>
        </div>
        <div class="botones-detalle">
            <a href="{{ route('item-partes.edit', $itemParte) }}" class="btn btn-pastel-edit">Editar</a>
