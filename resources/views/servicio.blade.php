...
<div class="header-container"> 
    ...
    <div id="menu-overlay" class="menu-overlay" onclick="closeMenu()"></div>
        ...
        <h1 class="titulos">Mantenimiento</h1>
    ...
    <div class="contenedor-wrapper">
        ...
        <form id="servicioForm" action="{{ route('servicio.store') }}" method="POST" enctype="multipart/form-data">
   ...
   <div class="container">
        ...
        <div class="col-md-4 col-12 mb-3">
            ...
            <div class="form-group w-100">
                <div class="input_consulta" style="width: 100%;">
                    ...
                    <select class="form-control" id="tipoEquipo" name="tipo_equipo" style="background-color: #ffff; display:block;" value="{{ old('Tipo_de_Equipo') }}"  required>
    ...
    <div class="form-group">
        <div class="input_consulta" style="width: 100%;">
            ...
            <select class="form-control" id="subtipoEquipo" name="subtipo_equipo" style="background-color: #ffff; display:block; width: 100%;" value="{{ old('Subtipo_de_Equipo') }}"required>
...
<div class="form-grupo col-md-6" style="margin-top: -200px; position: relative;">
    <div class="d-block w-100">
        ...
        <div class="d-flex align-items-center input-containerr">
            ...
            <input type="file" id="video-evidencia" name="video" class="file-input"
